...
//		JedisPool jedisPool = new JedisPool(null,"192.168.226.201",6379,100);
...
//    }
    ...
    public void setBit1(){
        Jedis jedis=jedisPool.getResource();
        jedis.setbit("bit",1,"1");
        jedis.setbit("bit",2,"1");
        jedis.setbit("bit",4,"1");
        jedis.setbit("bit",9,"1");
        jedis.setbit("bit",10,"1");
        jedis.setbit("bit",13,"1");
        jedis.setbit("bit",15,"1");
    }
    /**
     * <p>
     * 通过添加一个布尔类型，添加一个位图
    ...
    public Boolean setBit(String key,long offset,Boolean bool){
        ...
        try {
            jedis = jedisPool.getResource();
            isSet = jedis.setbit(key,offset,bool);
        } catch (Exception e) {
            log.error(e.getMessage());
        } finally {
            returnResource(jedisPool, jedis);
     ...
     * @return
     */
    public Long bitCountByRange(String key,Long start,Long end){
        Jedis jedis = null;
    ...
    public Long pfadd(String key,String... elements){
        ...
        try {
            jedis=jedisPool.getResource();
            count=jedis.pfadd(key,elements);
        } catch (Exception e) {
            log.error(e.getMessage());
        } finally {
            returnResource(jedisPool, jedis);
